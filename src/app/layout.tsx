...
export const metadata: Metadata = {
  title: "StyleHub | Premium Fashion Collections for Modern Living",  description: "Discover curated premium clothing and fashion pieces. Shop timeless styles with fast shipping and exceptional customer service at StyleHub.",  keywords: "fashion, clothing, premium apparel, style, designer wear, fashion collections",  metadataBase: new URL("https://stylehub.com"),
  alternates: {
    canonical: "https://stylehub.com"
  },
  openGraph: {
    title: "StyleHub | Premium Fashion Collections",    description: "Discover curated premium clothing and fashion pieces designed for modern living.",    type: "website",    siteName: "StyleHub",    images: [
      {
        url: "http://img.b2bpic.net/free-photo/full-length-view-laughing-woman-trench-coat_197531-19713.jpg",        alt: "StyleHub Fashion Collections"
      }
    ]
  },
  twitter: {
    card: "summary_large_image",    title: "StyleHub | Premium Fashion Collections",    description: "Discover curated premium clothing and fashion pieces designed for modern living.",    images: ["http://img.b2bpic.net/free-photo/full-length-view-laughing-woman-trench-coat_197531-19713.jpg"]
  },
  robots: {
    index: true,
    follow: true
